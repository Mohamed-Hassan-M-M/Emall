...
Route::group(['middleware' => 'locale'], function () {
    ...
    Route::group(['middleware' => 'auth:admin', 'prefix' => '/admin'], function () {
        ...
        //Delete
        Route::delete('/categories/{id}', 'Admin\CategoryController@destroy')->name('admin.categories.destroy');
    ...
    Route::group(['middleware' => 'auth:manager', 'prefix' => '/manager'], function () {
        ...
        Route::get('/getSubFeatures', 'Manager\ProductController@getSubFeatures');
        //--------------------------- Auth -------------------------------------//
        Route::get('/logout', 'Manager\Auth\LoginController@logout')->name('manager.logout');

        Route::get('/changeStatus/{id}/{value}', 'Manager\ProductController@changeStaus');
        ...
        Route::delete('/products/{id}', 'Manager\ProductController@destroy')->name('manager.products.destroy');
         ...
         //show reviews
        Route::get('/products/reviews/{id}', 'Manager\ProductController@showReview')->name('manager.productShowReview');
        ...
        //Manage
        Route::get('/delivery_boys/get_all', 'Manager\DeliveryBoyController@getAll')->name('manager.delivery-boys.get-all');
        Route::post('/delivery_boys/{id}/manage', 'Manager\DeliveryBoyController@manage')->name('manager.delivery-boys.manage');
