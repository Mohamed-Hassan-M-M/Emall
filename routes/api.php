...
Route::group(['prefix' => 'v1/user'], function () {
    ...
    //Print Receipt
    Route::get('/orders/{lang}/{id}/receipt', 'User\OrderReceiptController@show');
    ...
    Route::group(['middleware' => ['auth:user-api']], function () {
        ...
        //----------------- Products ------------------------------//
        Route::get('/products/{lang}', 'Api\v1\User\ProductController@index');
        Route::get('/products/{lang}/{id}', 'Api\v1\User\ProductController@show');
        Route::get('/products/{id}/reviews', 'Api\v1\User\ProductController@showReviews');


        //----------------- Cart -------------------------------//
        Route::get('/carts/{lang}', 'Api\v1\User\CartController@index');
        ...
        //------------------ Category-----------------------//
        Route::get('/categories/{lang}', 'Api\v1\User\CategoryController@index');

        //Category product
        Route::get('/categories/{lang}/{id}/products', 'Api\v1\User\CategoryController@getProducts');


        //---------------------- Order -----------------------//
        Route::get('/orders/{lang}', 'Api\v1\User\OrderController@index');
        Route::get('/orders/{lang}/{id}', 'Api\v1\User\OrderController@show');
        ...
        //---------------- Shop --------------------------//
        Route::get('/shops/{lang}/{id}', 'Api\v1\User\ShopController@show');
        Route::get('/shops/{lang}', 'Api\v1\User\ShopController@index');
        Route::get('/shops/{id}/coupons', 'Api\v1\User\ShopController@getCoupons');


        // ---------------------- Coupon ------------------------- //
        Route::get('/coupons/{lang}', 'Api\v1\User\CouponController@index');

        //coupon for shop
        Route::get('/shop_coupon/{lang}/{id}', 'Api\v1\User\UserCouponController@getForShop');
...
Route::group(['prefix' => '/v1/manager'], function () {
    ...
    Route::get('/app_data', 'Api\v1\Manager\ManagerController@getAppData');
    ...
    //Print Receipt
    Route::get('/orders/{lang}/{id}/receipt', 'Manager\OrderReceiptController@show');
    ...
    Route::group(['middleware' => ['auth:manager-api']], function () {
        ...
        //---------------------------- App Data -------------------------//
        //App User Data
        Route::get('/app_data/manager', 'Api\v1\Manager\ManagerController@getAppDataWithManager');
        ...
        //------------------- Orders ---------------------------------//
        Route::get('/orders/{lang}', 'Api\v1\Manager\OrderController@index');
        Route::get('/orders/{lang}/{id}', 'Api\v1\Manager\OrderController@show');
        ...
        //------------------- Products ---------------------------------//
        Route::get('/products/{lang}', 'Api\v1\Manager\ProductController@index');
        ...
        //Product show
        Route::get('/products/{lang}/{id}', 'Api\v1\Manager\ProductController@show');
        ...
        //-------------------------------- Shop --------------------------------//
        //Index
        Route::get('/shops/{lang}', 'Api\v1\Manager\ShopController@index');
        ...
        //--------------------------- Coupons -------------------------------------------//
        Route::get('/coupons/{lang}', 'Api\v1\Manager\ShopCouponController@index');
        ...
        //-------------------------------- Shop Request --------------------------------//
        //Index
       Route::get('/shop_requests/{lang}', 'Api\v1\Manager\ShopRequestController@index');
        ...
        //------------------ Category-----------------------//
        Route::get('/categories/{lang}', 'Api\v1\Manager\CategoryController@index');
    });
