                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{route('admin.products.index')}}">{{__('admin.product')}}</a></li>
                        <li class="breadcrumb-item active">{{__('admin.edit')}}</li>
                    </ol>
                </div>
                <h4 class="page-title">{{__('admin.edit_product')}}</h4>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card-box">
                        <div class="row bg-light py-1 px-3">
                            <h5 class="text-uppercase inline">{{__('admin.product_images')}} </h5>
                            <div class="col text-right">
                                <a
                                    href="{{route('admin.product-images.edit',['id'=>$product['id']])}}"
                    ...
                    <div class="card-box">
                        <h5 class="text-uppercase bg-light p-2 mt-0 mb-3">{{__('admin.general')}}</h5>

                        <div class="form-group custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="active"
                                   name="active" {{$product->active ? "checked" : ""}}>
                            <label class="custom-control-label" for="active">{{__('admin.active')}}
                                ({{__('admin.you_can_disable_or_enable_this_product')}})</label>
                        </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card-box">
                        <h5 class="text-uppercase mt-0 mb-3 bg-light p-2">{{__('admin.meta_data')}}</h5>

                        <div class="form-group mb-3">
                            <label for="offer">{{__('admin.offer')}} (%)</label>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card-box">
                        <h5 class="text-uppercase mt-0 mb-3 bg-light p-2">{{__('admin.items')}}</h5>
                        ...
                        <div class="mt-2">
                            <button type="button" id="add-item"
                                    class="btn w-sm btn-primary waves-effect waves-light">{{__('admin.add_item')}}</button>
                        </div>
                ...
                <div class="col-12">
                    <div class="text-right mb-3">
                        <button type="button" class="btn w-sm btn-light waves-effect">{{__('admin.cancel')}}</button>
                        <button type="button" id="submitBtn"
                                class="btn w-sm btn-success waves-effect waves-light">{{__('admin.save')}}</button>
                    </div>
                </div> <!-- end col-->
            </div>
    </form>
...
<script>
    ...
    formGroupInputQty.classList.add('form-group');
    const formGroupLabelQty = document.createElement('label');
    formGroupLabelQty.innerHTML = "{{__('manager.revenue_as_per_single_item')}}";
    formGroupLabelQty.for = "quantity";
    const inputQty = document.createElement('input');
    inputQty.type = "number";
    inputQty.min = "1";
