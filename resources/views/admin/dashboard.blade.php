        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">{{trans('admin.dashboard')}}</h4>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="text-right">
                                ...
                                <p class="text-muted mb-1 text-truncate">{{trans('admin.revenue')}}</p>
                            </div>
                        </div>
                    </div> <!-- end row-->
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="text-right">
                                ...
                                <p class="text-muted mb-1 text-truncate">{{trans('admin.orders')}}</p>
                            </div>
                        </div>
                    </div> <!-- end row-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="text-right">
                                ...
                                <p class="text-muted mb-1 text-truncate">{{trans('admin.delivery_boy')}}</p>
                            </div>
                        </div>
                    </div> <!-- end row-->
                </div> <!-- end widget-rounded-circle-->
        ...
        <div class="col">
            <div class="card-box pb-2">
                <div class="float-right d-none d-md-inline-block">
                    <h4 class="header-title mb-3">{{trans('admin.current_week')}}</h4>
                </div>

                <h4 class="header-title mb-3">{{trans('admin.sales_analytics')}}</h4>

                <div class="row text-center">
                    <div class="col-md-4">
                        <p class="text-muted mb-0 mt-3">{{trans('admin.weekly_orders')}}</p>
                    ...
                    <div class="col-md-4">
                        <p class="text-muted mb-0 mt-3">{{trans('admin.weekly_revenue')}}</p>
                        <h2 class="font-weight-normal mb-3">
